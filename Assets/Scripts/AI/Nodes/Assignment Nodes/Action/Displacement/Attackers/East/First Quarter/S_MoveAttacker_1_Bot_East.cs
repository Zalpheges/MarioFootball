...
public class S_MoveAttacker_1_Bot_East : Node
{
    ...
    public override (NodeState, Action) Evaluate()
    {
        ...
        {
            positionX += _root.Attacker_Offset_ShootQuarter_Side_Sideward.x;
            positionZ += _root.Attacker_Offset_ShootQuarter_Side_Sideward.y;
        }
        else if (_root.currentPlayerType == PlayerType.Attacker_Bot)
        {
            positionX += _root.Attacker_Offset_ShootQuarter_Side_Forward.x;
            positionZ += _root.Attacker_Offset_ShootQuarter_Side_Forward.y;
        }
